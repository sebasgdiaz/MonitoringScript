...
#Variables for EMAIL & Whatsapp

EMAIL_FROM="devethosjsg.5@gmail.com"
EMAIL_TO="devethosjsg.5@gmail.com"
EMAIL_USER="devethosjsg.5@gmail.com"
EMAIL_PASS="idjrmnrvsgguogqr"
WHATSAPP_TO="whatsapp:+61415751673"
